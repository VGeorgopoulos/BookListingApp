...
public final class QueryUtils {
    ...
    private static List<Book> extractItemsFromJson(String bookJSON) {
        ...
        try {
            ...
            for (int i = 0; i < bookArray.length(); i++) {
                ...
                Book book = new Book(bookTitle, bookAuthors, bookPageCount, bookPublishedDate, url);
    ...
    /**
     * Query the googleapis dataset and reurn a list of {@link Book} objects.
     */
    public static List<Book> fetchBookData(String requestUrl) {
        ...
        //Extract relevant fields from the JSON response and create a list of Bools
